...
class ScheduleModelEdu extends EducationModelEdu
{
    ...
    public function teacher_schedule ($where=null, $order='c_sch.start_time asc')
    {
        ...
        $_fields                =   "c_sch.id,c_sch.teacher_id,mxu1.full_name teacher_name,c_sch.start_time,c_sec.duration,DATE_ADD( c_sch.start_time, INTERVAL c_sec.duration MINUTE ) end_time,
