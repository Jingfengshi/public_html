...
class SectionModelEdu extends EducationModelEdu
{
    ...
    public function period_schedule ($where=null)
    {
        ...
        mxu1.full_name teacher_name,mxu2.full_name creator_name,c_sch.create_at,UNIX_TIMESTAMP(c_sch.start_time) stamp,mh.name homework_name,mv.name video_name';
